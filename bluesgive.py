...
BSKY_HANDLE = os.getenv("BSKY_HANDLE")  # Handle do Bluesky
BSKY_PASSWORD = os.getenv("BSKY_PASSWORD")  # Senha do Bluesky
...
def search_posts_by_hashtags(client: Client, hashtags: List[str]) -> Dict:
